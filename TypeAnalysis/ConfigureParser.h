...
public:
	...
	TypeAnalysis* Build();
	void printTable() { pRepo->printTable(); }
	TypeTable& getTable() { return pRepo->getTable(); }
private:
	...
	TypeAnalysis* pTypeAnalysis;
	Repository* pRepo;
	std::string file_;

	// add Rules and Actions
	DetectNamespace* pDetectNamespace;
	HandleNamespace* pHandleNamesapce;
	DetectClass* pDetectClass;
	HandleClass* pHandleClass;
	DetectStruct* pDetectStruct;
	HandleStruct* pHandleStruct;
	DetectEnum* pDetectEnum;
	HandleEnum* pHandleEnum;
	DetectTypeDef* pDetectTypeDef;
	HandleTypeDef* pHandleTypeDef;
	DetectAliases* pDetectAliases;
	HandleAliases* pHandleAliases;
	DetectGlobal* pDetectGlobal;
	HandleGlobal* pHandleGlobal;
